...
# 3A. Run analytical pipeline (uses Kallisto) - GT patient 7320 - jobID 13019959
...
# 3B. Run analytical pipeline (uses Kallisto) - GT patient 7319 - jobID 13021935
...
# 4A. Run analytical pipeline (uses Kallisto) - normal adj patient 7320 - jobID 13022769
