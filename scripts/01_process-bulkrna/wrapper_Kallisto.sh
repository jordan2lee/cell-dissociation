...
# 3A. Run analytical pipeline (uses Kallisto) - GT patient 7320
...
# 3B. Run analytical pipeline (uses Kallisto) - GT patient 7319
...
# 4A. Run analytical pipeline (uses Kallisto) - normal adj patient 7320
