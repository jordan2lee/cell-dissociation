...
# 2A. Run analytical pipeline (uses Kallisto) - patient 7320 - slurm job 15998279
...
# 2B. Run analytical pipeline (uses Kallisto) - patient 7319 - slurm job 15998280
...
# 3A. Run analytical pipeline (uses Kallisto) - GT patient 7320 - slurm job 15998281
...
# 3B. Run analytical pipeline (uses Kallisto) - GT patient 7319 - slurm job 15998282
...
# 4A. Run analytical pipeline (uses Kallisto) - normal adj patient 7320 - slurm job15998283
